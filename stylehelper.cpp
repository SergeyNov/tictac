...
QString StyleHelper::getStartButtonsStyle()
{
    return "QPushButton{"
           ...
           "    border:none;"
           "    border-radius:19px;"
           "    background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 rgba(89, 156, 208, 255), stop:1 rgba(65, 118, 184, 255));"
           "    font-family: 'Roboto Medium';"
           "    font-size:16px;"
           "}"
           "QPushButton::hover{"
           "    background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:0.955, stop:0 rgba(104, 173, 226, 255), stop:1 rgba(65, 118, 184, 255));"
           "}"
           "    QPushButton::pressed{"
           "    background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 rgba(89, 156, 208, 255), stop:1 rgba(65, 118, 184, 255));"
           "}";
...
{
    return "QPushButton{"
           "    background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0.0284091, stop:0 rgba(89, 156, 208, 255), stop:1 rgba(65, 118, 184, 255));"
